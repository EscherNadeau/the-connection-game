-- Cinema Connection Game Database Schema - RESET VERSION
-- This drops everything and recreates it fresh
...
-- Drop views first
DROP VIEW IF EXISTS top_players_by_mode CASCADE;
...
CREATE TABLE users (
  ...
  total_time_played BIGINT DEFAULT 0 NOT NULL,
